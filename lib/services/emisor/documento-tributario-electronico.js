...
const FORMATO_FECHAHORA = 'YYYY-MM-DDThh:mm:ss.000-06:00';
...
class DocumentoTributarioElectronico {
    ...
    crearElementoDatosGenerales(factura) {
        ...
        this.elementoDatosGenerales = {
            ...
            '@FechaHoraEmision': format(parse(factura.fecha_emision), FORMATO_FECHAHORA),
            ...
            return DocumentoTributarioElectronico.crearDocumento({
                AbonosFacturaCambiaria: {
                    Abono: {
                        ...
                        FechaVencimiento: format(parse(datos.fecha_vencimiento), FORMATO_FECHA),
        ...
        if (id_complemento === 4) {
            ...
            return DocumentoTributarioElectronico.crearDocumento({
                ReferenciasNota: {
                    ...
                    '@FechaEmisionDocumentoOrigen': format(parse(datos.fecha_emision), FORMATO_FECHA),
    ...
    crearElementoItems(tipoCambio, moneda, productosFactura, productosCatalogo, unidadesGravablesCatalogo) {
        ...
        if (productosFactura.length === 0) {
            this.elementoItemsYTotales = null;
        ...
        const items = productosFactura.map((productoEnFactura, index) => {
            ...
            const elementoImpuestos = producto.unidadesGravables.map((unidadGravable) => {
                ...
                totalImpuestosBrutos += montoImpuesto;
            ...
            const nodoImpuestos = elementoImpuestos.length === 0 ? {} : {
                Impuestos: {
            ...
            return {
                '#comment': JSON.stringify({
                    ...
                    totalImpuestos: totalImpuestosBrutos
                }),
        ...
        const elementoTotalesImpuestos = totalImpuestos.length === 0 ? {} : {
            TotalImpuestos: {
