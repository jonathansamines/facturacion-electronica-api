'use strict';
// Para mantener este modulo sincronizado, deshabilitamos las reglas de linting
/*eslint-disable */
...
function calcularDetalleProductoPorUnidadGravable({ unidadGravable, precio, descuento, unidades, moneda, tasaCambio }) {
  ...
  function calcularDetalleProducto({ tipoCambio, moneda, descuento, producto, unidadesGravables, unidades }) {
